...
def get_main_menu() -> dict:
    ...
    return {
        "inline_keyboard": [
            [
                {"text": "Купить аккаунты", "callback_data": "buy_accounts", "icon_custom_emoji_id": "5877485980901971030"},
...
def get_buy_services_keyboard(services: List[Dict[str, Any]], available_counts: Dict[int, int]) -> dict:
...
def get_categories_keyboard(service_id: int, categories: Dict[str, Dict[str, Any]]) -> dict:
    """
