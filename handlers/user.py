...
PRIVACY_POLICY_TEXT = (
    ...
    "1.1. Настоящая Политика регулирует порядок обработки и защиты информации, которую Пользователь передаёт при использовании Сервиса.\n"
    "1.2. Используя Сервис, Пользователь подтверждает своё согласие с условиями Политики. Если не согласен — обязан прекратить использование.\n\n"

    "<b>2. Сбор информации</b>\n"
    "2.1. Сервис может собирать:\n"
    "• идентификаторы аккаунта (логин, ID, никнейм);\n"
    "• техническую информацию (IP-адрес, данные об устройстве и ОС);\n"
    "• историю взаимодействий с Сервисом.\n"
    "2.2. Сервис не требует паспортных данных, документов или фотографий.\n\n"
    ...
    "4.1. Данные не передаются третьим лицам, кроме случаев:\n"
    "• если это требуется по закону;\n"
    "• если необходимо для исполнения обязательств (платёжные системы);\n"
    "• если Пользователь сам дал согласие.\n\n"

    "<b>5. Хранение и защита данных</b>\n"
    "5.1. Данные хранятся в течение срока, необходимого для целей обработки.\n"
    "5.2. Администрация принимает разумные меры защиты, но не гарантирует абсолютную безопасность при передаче через интернет.\n\n"

    "<b>6. Отказ от ответственности</b>\n"
    "6.1. Передача информации через интернет всегда сопряжена с рисками.\n"
    "6.2. Администрация не несёт ответственности за утрату или раскрытие данных по вине третьих лиц или самого Пользователя.\n\n"

    "<b>7. Изменения в Политике</b>\n"
    "7.1. Администрация вправе изменять условия Политики без уведомления.\n"
    "7.2. Продолжение использования Сервиса означает согласие с новой редакцией."
)
...
USER_AGREEMENT_TEXT = (
    ...
    "<b>1. Общие положения</b>\n"
    "1.1. Настоящее Соглашение регулирует порядок использования Сервиса, предоставляемого Администрацией.\n"
    "1.2. Используя Сервис, Пользователь подтверждает полное принятие условий Соглашения.\n"
    ...
    "2.2. Ценность товаров заключается в систематизации, анализе, форме подачи и сопровождении.\n"
    "2.3. Сервис не гарантирует уникальность или недоступность отдельных элементов вне Сервиса.\n\n"

    "<b>3. Отказ от гарантий и ответственности</b>\n"
    "3.1. Сервис предоставляется на условиях «AS IS» («как есть»).\n"
    "3.2. Администрация не гарантирует соответствие Сервиса ожиданиям и достижение каких-либо результатов.\n"
    "3.3. Администрация не несёт ответственности за убытки, последствия применения материалов и технические сбои.\n\n"

    "<b>4. Законность использования</b>\n"
    "4.1. Пользователь обязуется использовать Сервис исключительно в рамках применимого законодательства.\n"
    "4.2. Ответственность за законность использования материалов полностью возлагается на Пользователя.\n\n"

    "<b>5. Интеллектуальная собственность</b>\n"
    "5.1. Все материалы Сервиса охраняются законодательством об интеллектуальной собственности.\n"
    "5.2. Запрещается копировать, распространять или перепродавать материалы без разрешения правообладателя.\n\n"

    "<b>6. Ограничение доступа</b>\n"
    "6.1. Администрация вправе приостановить доступ при нарушении Соглашения или выявлении злоупотреблений.\n"
    "6.2. Ограничение доступа не освобождает от обязательств, возникших ранее.\n\n"

    "<b>7. Платежи и возвраты</b>\n"
    "7.1. В связи с нематериальным характером товаров возврат после предоставления доступа не осуществляется.\n"
    "7.2. Возврат возможен только если услуга не была оказана по технической вине Сервиса.\n"
    "7.3. Для рассмотрения возврата необходимо обратиться в поддержку в течение 24 часов с момента оплаты.\n"
    "7.4. Пользователь обязуется не инициировать чарджбэк без предварительного обращения в поддержку.\n\n"

    "<b>8. Конфиденциальность</b>\n"
    "8.1. Администрация собирает минимально необходимые данные для работы Сервиса.\n"
    "8.2. Администрация принимает разумные меры защиты, но не гарантирует абсолютную безопасность.\n\n"

    "<b>9. Изменение условий</b>\n"
    "9.1. Администрация вправе вносить изменения в Соглашение.\n"
    "9.2. Продолжение использования Сервиса означает согласие с обновлёнными условиями.\n\n"

    "<b>10. Контактная информация</b>\n"
    "10.1. По всем вопросам обращайтесь в службу поддержки через форму в боте.\n\n"

    "<i>Запуская бота и вводя /start, Пользователь подтверждает принятие настоящего Соглашения.</i>"
)
